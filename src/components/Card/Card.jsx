...
const DivCard = styled.div`
  ...
  &:hover {
    box-shadow: 0px 0px 5px 2px ${c.VERDE1}, 0px 0px 10px 4px ${c.TURQUEZA};
  }
`;
...
const ButtonCard = styled.button`
  ...
  color: ${c.DARK};
  -webkit-text-stroke: 0.5px ${c.DARK};
  ...
  &:hover {
    ...
    -webkit-text-stroke: 0.5px ${c.TURQUEZA};
...
const H2Name = styled.h2`
  ...
  font-weight: 300;
  color: ${c.TURQUEZA};
  -webkit-text-stroke: 0.7px ${c.VERDE2};
...
const Details = styled.span`
  ...
  &:hover {
    color: ${c.VERDE2};
    background-color: ${c.DARK};
    -webkit-text-stroke: 0.3px ${c.TURQUEZA};
    box-shadow: 1px 1px 2px 2px ${c.VERDE2};
  }
  ${DivCard}:hover & {
    bottom: 4px;
